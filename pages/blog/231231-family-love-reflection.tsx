        ...
        <>
            ...
            <div className="flex flex-col justify-center items-center">
                <div className="p-5 md:max-w-7xl">
                    ...
                    <p className="pb-3">We’re so blessed to have family traditions that we can continue for our girls. Mikki used to tell me about Christmases with his family in the Philippines. Like Santa visits, performances with his brothers and cousins for presents . . . It was something Mikki’s mom wanted to continue for her grandchildren and we’re grateful to be a part of that and keep the magic alive for the girls.</p>
                    <p className="pb-3">And everyone knows my mom’s love language--it’s cooking with such love that once it hits your mouth, it immediately warms your heart. The early mornings, the smell that fills the kitchen, family in every corner of the house--that’s Christmas to me. I had the opportunity to learn my kitchen skills from my mom, who learned from her dad and now Sofia is starting to learn from the best mama chef out there. She’s a great helper and said that one day she wants to be a doctor chef.</p>
                    <p className="pb-3">If you can’t tell, we love our parents and being around them. We have so much fun with them and love the love the give. Each year we take a family trip to Enchant to see the lights and take in the Christmas air. Selena has become such a great walker, that she definitely enjoyed running around with her sister. Memories like these are just so fun to make and are so precious to us because we can’t rewind time.</p>
                    ...
                    {/* content */}
                    <p className="pb-3">We started taking the girls to parks to play and release their energy. They just have so much energy! Selena is starting to love to run and jump (without her feet leaving the floor, so more like squats) and she’s babbling so much. We were joking around like how is that all our kids want to keep on moving. All three of them! Embee, Sofia, and now Selena.</p>
                    <p className="pb-3">We love it all though. Selena is such a goofball. She’s shy, but loves to run up to people and run away when they say hi to her. She’s sweet and oftentimes will be the one comforting Sofia when she’s down or hurt. She absolutely hates things in her hair. So if you’re wondering why her hair is always in her eyes, that’s because she pulls out anything we put on her head. She likes it, so it is what it is.</p>
